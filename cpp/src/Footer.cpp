...
id3v2::Footer::Footer(const id3v2::Footer & other) {
	*this = other;
};

id3v2::Footer::~Footer() { };

id3v2::Footer & id3v2::Footer::operator=(const id3v2::Footer & other) {
	if (this == &other)
		return (*this);
	state = other.state;
...
bool id3v2::Footer::get_footer(std::ifstream & file) {
	char	buf[10];
